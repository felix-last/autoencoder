...
Modified version by https://github.com/felix-last
...
SIZE = 100  # for ImageNet models compatibility
TEST_DIR = './datasets/asirra/test/'
TRAIN_DIR = './datasets/asirra/train/'
BASE_DIR = './datasets/asirra'
